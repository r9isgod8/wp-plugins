...
class WP_Optimize_Premium {
	...
	public function enqueue_scripts_styles() {
		...
		wp_enqueue_script('wp-optimize-premium-js', WPO_PLUGIN_URL . 'js/wpo-premium' . $min_or_not_internal . '.js', array('jquery', 'jquery-ui-dialog', 'wp-optimize-admin-js', 'jquery-ui-datepicker', 'select2'), $enqueue_version);
	...
	public function add_default_values_to_cache_config($config) {
		...
		if (function_exists('get_woocommerce_currency')) {
			...
			if (apply_filters('wpo_add_woocommerce_default_currency_to_cache_config', true)) {
				...
				$config['default_values']['woocommerce_currency'] = get_woocommerce_currency();
			}
		}
