...
abstract class ArContactUsConfigModel extends ArContactUsConfigModelAbstract
{
    ...
    {
        return array(
            'regular' => __('Menu', AR_CONTACTUS_TEXT_DOMAIN),
            'callback' => __('Callback only', AR_CONTACTUS_TEXT_DOMAIN)
        );
    }
    ...
    {
        return array(
            'huge' => __('Huge', AR_CONTACTUS_TEXT_DOMAIN),
            'large' => __('Large', AR_CONTACTUS_TEXT_DOMAIN),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'sandbox' => __('Sandbox mode', AR_CONTACTUS_TEXT_DOMAIN),
            'allowed_ips' => __('Allowed IPs', AR_CONTACTUS_TEXT_DOMAIN),
            
            'mode' => __('Button mode', AR_CONTACTUS_TEXT_DOMAIN),
            ...
            'show_after_close' => __('Show after closed', AR_CONTACTUS_TEXT_DOMAIN),
            ...
            'onesignal_app_id' => __('Onesignal APP ID', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_api_key' => __('Onesignal Api Key', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_title' => __('Webpush message title', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_message' => __('Webpush message text', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_alert' => '',
            ...
            'zalo_head' => '',
            'zalo_id' => __('Account ID', AR_CONTACTUS_TEXT_DOMAIN),
            'zalo_on' => __('Enable', AR_CONTACTUS_TEXT_DOMAIN),
            'zalo_welcome' => __('Welcome message', AR_CONTACTUS_TEXT_DOMAIN),
            'zalo_height' => __('Height', AR_CONTACTUS_TEXT_DOMAIN),
            'zalo_width' => __('Width', AR_CONTACTUS_TEXT_DOMAIN),
    ...
    public function fieldSuffix()
    {
        return array(
            ...
            'zalo_width' => __('px', AR_CONTACTUS_TEXT_DOMAIN),
            'zalo_height' => __('px', AR_CONTACTUS_TEXT_DOMAIN),
            'show_after_close' => __('minutes', AR_CONTACTUS_TEXT_DOMAIN),
        );
    }
    ...
    public function attributeDescriptions()
    {
        return array(
            ...
            'allowed_ips' => sprintf(__('One IP address per line. Your current IP %s', AR_CONTACTUS_TEXT_DOMAIN), $this->getCurrentIP()),
            'sandbox' => __('If enabled, module will be shown from allowed IPs only.', AR_CONTACTUS_TEXT_DOMAIN),
            ...
            'twilio_message' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_title' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', AR_CONTACTUS_TEXT_DOMAIN),
            'onesignal_message' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', AR_CONTACTUS_TEXT_DOMAIN),
            ...
            'zopim_id' => __('Zopim or Zendesk chat Widget ID', AR_CONTACTUS_TEXT_DOMAIN),
            'show_after_close' => __('Show prompt messages again if visitor has closed prompts after this interval (in minutes). Type 0 if you want to show prompts on next session. Type -1 to show prompts after page reload', AR_CONTACTUS_TEXT_DOMAIN),
        );
    }
    ...
    public function htmlFields()
    {
        return array(
            ...
            'hr7' => '<hr/>',
            'zalo_head' => '<h3 class="section-head">' . __('Zalo chat widget', AR_CONTACTUS_TEXT_DOMAIN) . '</h3>',
            'fb_alert' => '<div class="ui error message" style="display: block">' . __('Facebook customer chat requires HTTPS for full functionality', AR_CONTACTUS_TEXT_DOMAIN) . '</div>',
            'onesignal_alert' => '<div class="ui error message" style="display: block">' . __('Onesignal requires HTTPS', AR_CONTACTUS_TEXT_DOMAIN) . '</div>',
        );
    }
}
