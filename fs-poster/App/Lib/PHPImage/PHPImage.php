...
namespace FSPoster\App\Lib\PHPImage;
...
class PHPImage {
	...
	public function textBox($text, $options=array()){
		...
		return $this->text($this->wrap($text, $width, $fontSize, $angle, $fontFile), array('fontSize' => $fontSize, 'x' => $x, 'y' => $y, 'width' => $width, 'height' => $height, 'angle' => $angle, 'strokeWidth' => $strokeWidth, 'opacity' => $opacity, 'fontColor' => $fontColor, 'strokeColor' => $strokeColor, 'fontFile' => $fontFile, 'alignHorizontal' => $alignHorizontal, 'alignVertical' => $alignVertical, 'debug' => $debug));
	}
