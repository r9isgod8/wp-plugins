...
class OdnoKlassniki
{
	...
	public static function authorizeOkUser( $appId , $appPublicKey , $appPrivateKey , $accessToken , $refreshToken , $scExpireIn , $proxy)
	{
		...
		$checkLoginRegistered = DB::fetch('accounts' , ['user_id' => get_current_user_id() , 'driver' => 'ok', 'profile_id' => $meId]);
		...
		if( isset( $groupIDsList['groups'] ) && in_array( $groupIDsList['groups'] ) )
		{
