...
class FacebookCookieApi
{
	...
	public function authorizeFbUser()
	{
		...
		$checkLoginRegistered = DB::DB()->get_row( DB::DB()->prepare( "SELECT * FROM ".DB::table('accounts')." WHERE user_id=%d AND driver='fb' AND profile_id=%s" , [get_current_user_id() ,$myInfo['id']] ) , ARRAY_A );
