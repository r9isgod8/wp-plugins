...
<div style="width: 100%; margin-top: 47px; display: flex; justify-content: center; align-items: center;">
	<div class="twitter_logo"><img src="<?=Helper::assets('images/twitter.png')?>"></div>

	<div style="width: 45%; <?php print count($applications) ? 'display: none;' : ''?> font-size: 15px; line-height: 23px;">
		<?=__('First you should create your Pinterest App. Please follow the below documentation:<br><a href="https://www.fs-poster.com/doc/add-pinterest-account" target="_blank">How to add the Pinterest account</a>' , 'fs-poster')?>
	</div>
	<div style="width: 45%; <?php print count($applications) ? '' : ' display: none;'?>">
...
<script>
	...
	$("#addAccountBTN").click(function ()
	{
		...
		{
			openURL = "<?=Helper::standartAppRedirectURL('twitter')?>&proxy=" + $("#proxyInput").val();
		}
