...
<div style="width: 100%; margin-top: 47px; display: flex; justify-content: center; align-items: center;">
	<div class="linkedin_logo"><img src="<?=Helper::assets('images/linkedin.svg')?>"></div>
	<div style="width: 45%;">
...
<script>
	...
	function compleateOperation( status, errorMsg )
	{
		if( status )
		{
			...
			$('#fs_account_supports .fs_social_network_div[data-setting="linkedin"]').click();
		}
		else
		{
	...
	$("#addAccountBTN").click(function ()
	{
		...
		{
			openURL = "<?=Helper::standartAppRedirectURL('linkedin')?>&proxy=" + $("#proxyInput").val();
		}
