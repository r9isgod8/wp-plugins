...
<div class="ws_step1">
	...
	<div class="ws_methods">
		<div class="ws_method_box ws_method_selectted_box" data-type="3">
			<div class="ws_method_box_img"><i class="fab fa-android"></i></div>
			<div class="ws_method_box_label ws_tooltip" data-title="Recomended" data-float="left"><?=esc_html__('App method', 'fs-poster')?></div>
		</div>
...
<div class="ws_step22" style="display: none;">
	...
	<div style="width: 100%; margin-top: 30px; display: flex; justify-content: center; align-items: center;">
		<div class="fb_logo"><img src="<?=Helper::assets('images/fb.svg')?>"></div>
		<div style="width: 45%;">
			...
			<div style="padding-top: 20px; font-size: 17px; color: #888; font-weight: 600; margin-right: 20px;">
				...
				<a href="https://www.fs-poster.com/doc/add-facebook-account-with-cookie-method" target="_blank" class="ws_tooltip" data-title="How to?"><i class="fa fa-question-circle" style="color: #ff7171;"></i></a>
			</div>
...
<div class="ws_step23" style="display: none;">
	...
	<div class="ws_step23_head" style="background-image: url('<?=Helper::assets('images/bg3.png')?>');">
...
<script>
	...
	function setAccessToken(access_token)
	{
		...
		var app_id = $("#proModal<?=$mn?> .ws_step23 #appSelect2").val();

		fsCode.ajax('add_new_fb_account_with_at' , {'access_token': access_token , 'proxy': proxy, 'app_id': app_id} , function(result)
		{
	...
	jQuery(document).ready(function()
	{
		...
		$("#proModal<?=$mn?> .ws_step23 .next_step_btn").click(function()
		{
			...
			{
				openURL = "<?=Helper::standartAppRedirectURL('fb')?>&proxy=" + proxy;
			}
