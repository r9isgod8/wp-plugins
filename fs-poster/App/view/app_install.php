...
$checkRequirements = Helper::checkRequirments( false );
...
<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
	...
	<div style="margin: 50px;"><img src="<?=Helper::assets('images/logo.svg')?>" style="width: 400px;"></div>
	...
	<div style="width: 350px; margin-top: 5px;">
		<select class="ws_form_element" id="marketing_statistic">
			<?php
			print Helper::fetchStatisticOptions();
			?>
		</select>
	</div>
	...
	<div style="width: 350px; margin-top: 5px;"><input type="text" class="ws_form_element2" id="purchaseKey" placeholder="<?=__('Please Enter web4sync.com' , 'fs-poster')?>"></div>
