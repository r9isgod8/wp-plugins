...
foreach($report4Data AS $r4Data)
{
	...
	$nodeInf = DB::fetch($nodeInfTable , $nodeId);
	...
	$report4['labels'][] = esc_html(ucfirst($nodeInf['driver']) . ' / ' . Helper::cutText($nodeInf['name'] , 20));
}
...
$accounts = DB::DB()->get_row(DB::DB()->prepare( "SELECT COUNT(0) AS c FROM ".DB::table('accounts') . " tb1 WHERE is_public=1 OR user_id=%d", [get_current_user_id()] ) , ARRAY_A);

$nodes = DB::DB()->get_row(DB::DB()->prepare("SELECT COUNT(0) AS c FROM ".DB::table('account_nodes') . " tb1 WHERE is_public=1 OR user_id=%d", [get_current_user_id()]) , ARRAY_A);
...
<div class="stat_boxes">
	...
	<div class="ws_bg_warning">
		...
		<div class="title1"><?=esc_html__('Clicks this month' , 'fs-poster');?></div>
	</div>
	...
	<div class="ws_bg_purple">
		<div class="num1"><?=(int)$hitsThisMonthSchedule['c']?></div>
		<div class="title1"><?=esc_html__('Clicks this month from Schedules' , 'fs-poster')?></div>
	</div>
</div>
...
<div class="reports_group">
	...
	<div style="width: 50%;">
		<div class="report_title">
			<div class="title1"><i class="fa fa-chart-bar"></i> <?=esc_html__('Clicks count' , 'fs-poster');?></div>
...
<div class="reports_group">
	<div style="width: 50%;">
		<div class="report_title">
			<div class="title1"><i class="fa fa-copy"></i> <?=esc_html__('Social networks comparison ( by clicks )' , 'fs-poster');?></div>
		</div>
		<div class="report_chart_box">
	...
	<div style="width: 50%;">
		<div class="report_title">
			<div class="title1"><i class="fa fa-copy"></i> <?=esc_html__('Accounts comparison ( by clicks )' , 'fs-poster');?></div>
		</div>
		<div class="report_chart_box">
