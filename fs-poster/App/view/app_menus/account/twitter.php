				...
				<tbody>
					<tr data-id="<?=$accountInf['id']?>" data-type="account">
						<td>
							...
							<a href="<?=Helper::profileLink($accountInf)?>" target="_blank" class="ws_btn ws_tooltip" data-title="<?=esc_html__('Profile link', 'fs-poster')?>" style="font-size: 13px; color: #fd79a8;"><i class="fa fa-external-link fa-external-link-alt"></i></a>
						</td>
