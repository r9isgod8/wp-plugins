...
$settingTab = Request::get('setting' , 'share' , 'string' , ['general' , 'share', 'url' , 'facebook' , 'instagram' , 'twitter', 'linkedin' , 'vk' , 'tumblr' , 'pinterest' , 'reddit' , 'ok' , 'google_b', 'telegram', 'medium']);
?>
...
<form class="settings_form fs_settings_panel">
	...
	<div class="fs_settings_panel_r">
		<?php
		Helper::view('app_menus.settings.' . $settingTab);
		?>
