...
<div class="fs_setting_item">
	...
	<div class="fs_s_input" style="width: 45%;">
		<textarea class="ws_form_element2" name="fs_post_text_message_linkedin" id="custom_text_area" style="height: 150px !important;"><?=esc_html(get_option('fs_post_text_message_linkedin', "{title}"))?></textarea>
	</div>
</div>
...
<script>
	...
	jQuery(document).ready(function()
	{
		$("#save_btn").click(function()
		{
			...
			fsCode.ajax('settings_linkedin_save' , data , function(result)
			{
