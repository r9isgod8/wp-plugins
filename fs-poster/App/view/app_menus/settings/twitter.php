	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Twitter limits Tweet length to a maximum of 280 characters for display.  By enabling the option, the first 280 characters of your text will be shared; otherwise, the tweet will not be shared because of exceeding.' , 'fs-poster')?></div>
			</div>
	...
	<div style="">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label" style="width: 55%;">
				...
				<div class="fs_s_help"><?=esc_html__('Choose a method to share your tweets: Link card view – share the tweets with the link; Upload featured image only - upload and share featured image only; Upload all post images - upload and share featured image and all attached images as albom.' , 'fs-poster')?></div>
			</div>
