...
<div class="fs_setting_item" style="width: 50%;">
	<div class="fs_setting_item_label">
		...
		<div class="fs_s_help"><?=esc_html__('Sharing the same post in numerous amounts of communities might be accepted as duplicated posts by Facebook; consequently, the posts might be blocked. By enabling the option, the ending of each link gets random symbols; so that, the post becomes unique.' , 'fs-poster')?></div>
	</div>
...
<div class="fs_setting_item" style="width: 50%;">
	<div class="fs_setting_item_label">
		...
		<div class="fs_s_help"><?=esc_html__('Enable to shorten your post URLs automatically.' , 'fs-poster')?></div>
	</div>
	<div class="fs_s_input">
		<div class="fs_onoffswitch">
...
<div class="fs_setting_item" style="width: 50%;">
	<div class="fs_setting_item_label">
		...
		<div class="fs_s_help"><?=esc_html__('Enable to define and type your Custom Post URL using specific keywords.' , 'fs-poster')?></div>
	</div>
	<div class="fs_s_input">
		<div class="fs_onoffswitch">
...
<div class="fs_setting_item" id="addition_url_parameters_section" style="width: 100%;">
	<div class="fs_setting_item_label" style="width: 50%;">
		<div>
			<?=esc_html__('Additional URL parameters:' , 'fs-poster')?> ( <a href="javascript:;" id="use_google_a_template">Use Google Analytics template</a> )
		</div>
		<div class="fs_s_help">
