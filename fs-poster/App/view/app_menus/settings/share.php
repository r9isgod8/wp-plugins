...
<div class="fs_setting_item" style="width: 50%;">
	<div class="fs_setting_item_label">
		...
		<div class="fs_s_help"><?=__('When you add a new post, the plugin publishes the post automatically on all active social accounts.' , 'fs-poster')?></div>
	</div>
...
<div style="display: flex;">
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Share process runs in the background; therefore, you do not need to wait for the process to complete.' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
				<div class="fs_onoffswitch">
	...
	<div style="width: 50%;" id="hide_11">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				<div><?=esc_html__('Timer for sharing (min.):' , 'fs-poster')?></div>
				<div class="fs_s_help"><?=esc_html__('Set a time for sharing the post after creating one. Default is 0 to share immediately' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
...
<div class="fs_setting_item" style="width: 50%;">
	<div class="fs_setting_item_label">
		...
		<div class="fs_s_help"><?=__('If you do not want to keep logs of shared posts, you have to disable this option. <span class="ws_color_warning">Note!</span> If you disable this option, you cannot view your insights.' , 'fs-poster')?></div>
	</div>
	<div class="fs_s_input">
		<div class="fs_onoffswitch">
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Define the interval between publications for each social account to regulate posting speed.' , 'fs-poster');?></div>
			</div>
