...
?>
<script type="text/javascript" src="<?=Helper::assets('js/jscolor.js')?>"></script>
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Choose where to share the post on Instagram.' , 'fs-poster');?></div>
			</div>
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=__('When you share a post in the story, the post link will be added automatically ( <b style="color: #9e6a6d; font-weight: 700;">Note:</b> Only business accounts with >= 10k followers and cookie method is not allowed. ).', 'fs-poster');?></div>
			</div>
...
<div style="display: flex; height: 450px;">
	...
	<div style="width: 400px;">
		<div id="instagram_status_preview">
			...
			<div class="story_img"><img src="<?=Helper::assets('images/sample_story_img.png')?>"</div>
		</div>
	</div>
</div>
